...
(function ($) {
	...
	////////////////////////////////////////////////////
	// Mobile Menu Js
	// รอให้ header components โหลดเสร็จก่อน initialize
	...
	// Hamburger Menu Js - ใช้ event delegation เพื่อรองรับ dynamic content
	...
	function gsapController() {
		...
		if ($(".zoom-on-scroll-opacity").length > 0) {
			mediaMatch.add("(min-width: 0)", () => {
				let zoomElements = document.querySelectorAll(".zoom-on-scroll-opacity");
				// Set initial scale
				gsap.set(zoomElements, {
					scale: 0.74,
					transformOrigin: "center center",
	...
	////////////////////////////////////////////////////
	// Desktop Menu Click Dropdown (Desktop only - min-width: 992px)
	function desktopMenuClickDropdown() {
		// Only apply on desktop screens
		if ($(window).width() >= 992) {
			// Handle main menu items with dropdown
